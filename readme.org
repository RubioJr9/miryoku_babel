...
*** Num - Benford
# Based on https://en.wikipedia.org/wiki/Benford%27s_law
#+NAME: num-benford-r
| (   | 7 |   8 |    9 | )    |
| +   | 1 |   2 |    3 | 4    |
| -   | 5 |   6 |    * | /    |
...
|      | ALGR      | LOCK_OPP    | LOCK_CUR   | U_FUN   |        | LOCK_CUR   | LOCK_OPP    | ALGR      |      |
| U_NP | U_NP      | U_MEDIA     | U_NAV      | U_BNFRD | U_NSYM | U_PUNC     | U_BRAC      | U_NP      | U_NP |

**** RHold

#+NAME: rhold
| BOOT | DF(U_TAP) | DF(U_EXTRA) | DF(U_BASE) | U_MEDIA  | U_FUN   | DF(U_BASE) | DF(U_EXTRA) | DF(U_TAP) | BOOT |
| LGUI | LALT      | LCTL        | LSFT       |         |          | LSFT       | LCTL        | LALT      | LGUI |
|      | ALGR      | LOCK_OPP    | LOCK_CUR   |         |          | LOCK_CUR   | LOCK_OPP    | ALGR      |      |
| U_NP | U_NP      | U_RBRAC     | U_RPUNC    | U_RNSYM | U_RBNFRD | U_RNAV     |             | U_NP      | U_NP |
...
#+NAME: media-r
| OUT_TOG  | RGB_TOG  | RGB_HUI  | RGB_SAI  | RGB_VAI  |
| BT_CLR   | MPRV     | VOLD     | VOLU     | MNXT     |
...
***** Righty Layer
#+NAME: righty
| Q            | U    | ,    | L   | Z   | K   | F | Y   | C    | TG(U_RIGHTY) |
| O            | I    | A    | N   | W   | P   | H | T   | S    | R            |
| TG(U_RIGHTY) | DEL  | .    | M   | X   | B   | D | G   | V    | J            |
...
| WH_R         | WH_R         | U_WH_R        |               |
| WH_U         | WH_U         | U_WH_U        |               |
| TG(U_RIGHTY) | TG(U_RIGHTY) | &tog U_RIGHTY |               |
...
//#if !defined(MIRYOKU_LAYER_RIGHTY)
//  #define MIRYOKU_LAYER_RIGHTY MIRYOKU_ALTERNATIVES_RIGHTY
//#endif
//#if !defined(MIRYOKU_LAYERMAPPING_RIGHTY)
//  #define MIRYOKU_LAYERMAPPING_RIGHTY MIRYOKU_MAPPING
//#endif

//#if !defined(MIRYOKU_LAYER_RNSYM)
//  #define MIRYOKU_LAYER_RNSYM MIRYOKU_ALTERNATIVES_RNSYM
//#endif
//#if !defined(MIRYOKU_LAYERMAPPING_RNSYM)
//  #define MIRYOKU_LAYERMAPPING_RNSYM MIRYOKU_MAPPING
//#endif

//#if !defined(MIRYOKU_LAYER_RBRAC)
//  #define MIRYOKU_LAYER_RBRAC MIRYOKU_ALTERNATIVES_RBRAC
//#endif
//#if !defined(MIRYOKU_LAYERMAPPING_RBRAC)
//  #define MIRYOKU_LAYERMAPPING_RBRAC MIRYOKU_MAPPING
//#endif

//#if !defined(MIRYOKU_LAYER_RBNFRD)
//  #define MIRYOKU_LAYER_RBNFRD MIRYOKU_ALTERNATIVES_RBNFRD
//#endif
//#if !defined(MIRYOKU_LAYERMAPPING_RBNFRD)
//  #define MIRYOKU_LAYERMAPPING_RBNFRD MIRYOKU_MAPPING
//#endif

//#if !defined(MIRYOKU_LAYER_RPUNC)
//  #define MIRYOKU_LAYER_RPUNC MIRYOKU_ALTERNATIVES_RPUNC
//#endif
//#if !defined(MIRYOKU_LAYERMAPPING_RPUNC)
//  #define MIRYOKU_LAYERMAPPING_RPUNC MIRYOKU_MAPPING
//#endif

//#if !defined(MIRYOKU_LAYER_RNAV)
//  #define MIRYOKU_LAYER_RNAV MIRYOKU_ALTERNATIVES_RNAV
//#endif
//#if !defined(MIRYOKU_LAYERMAPPING_RNAV)
//  #define MIRYOKU_LAYERMAPPING_RNAV MIRYOKU_MAPPING
//#endif
#+END_SRC
...
<<table-layer-full(alphas_table=rsthp, thumbs_table=thumbs)>>
...
<<table-layer-full(current_layer_name="U_NSYM",  half_table=sym-l, mode="l")>>
...
//<<table-layer-taphold(alphas_table=righty, thumbs_table=thumbs-flip, hold_table=rhold)>>

//#define MIRYOKU_ALTERNATIVES_RNAV \
//<<table-layer-half(current_layer_name="U_RNAV", half_table=rnav, mode='r')>>

//#define MIRYOKU_ALTERNATIVES_BNFRD \
//<<table-layer-half(current_layer_name="U_BNFRD", half_table=bnfrd-r, mode="r")>>

//#define MIRYOKU_ALTERNATIVES_RBNFRD \
//<<table-layer-full(alphas_table=rbnfrd)>>

//#define MIRYOKU_ALTERNATIVES_RNSYM \
//<<table-layer-full(alphas_table=rnsym)>>

//#define MIRYOKU_ALTERNATIVES_RPUNC \
//<<table-layer-full(alphas_table=rpunc)>>

//#define MIRYOKU_ALTERNATIVES_RBRAC \
//<<table-layer-full(alphas_table=rbrac)>>
#+END_SRC
