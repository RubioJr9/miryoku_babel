...
| TG(RIGHTY)  | TG(RIGHTY)  | &tog RIGHTY   |               |
...
#include "miryoku_layer_alternatives.h"
  ...
  /* #endif */
  #define MIRYOKU_LAYER_NUM MIRYOKU_ALTERNATIVES_NUM_BENFORD
#endif
...
#define MIRYOKU_ALTERNATIVES_NUM_BENFORD \
<<table-layer-half(current_layer_name="U_NUM", opposite_layer_name="U_NAV", half_table=num-benford-r, mode="r")>>
...
/* <<table-layer-full(table=righty, hold_table=hold-flip)>> */
<<table-layer-taphold(alphas_table=righty, thumbs_table=thumbs-flip, hold_table=hold-flip)>>
