...
&kp A,             &kp Z,             &kp E,             &kp R,             &kp T,             &kp Y,             &kp U,             &kp I,             &kp O,             &kp P,             \
U_MT(LGUI, Q),     U_MT(LALT, S),     U_MT(LCTRL, D),    U_MT(LSHFT, F),    &kp G,             &kp H,             U_MT(LSHFT, J),    U_MT(LCTRL, K),    U_MT(LALT, L),     U_MT(LGUI, M),     \
&kp W,             U_MT(RALT, X),     &kp C,             &kp V,             U_LT(U_MEDIA, B),  U_LT(U_FUN, N),    U_MT(RALT, COMMA), &kp DOT,           &kp SLASH,         &kp SQT,           \
...
&kp Q,             &kp H,             &kp O,             &kp U,             &kp X,             &kp G,             &kp C,             &kp R,             &kp F,             &kp Z,             \
U_MT(LGUI, Y),     U_MT(LALT, I),     U_MT(LCTRL, E),    U_MT(LSHFT, A),    &kp DOT,           &kp D,             U_MT(LSHFT, S),    U_MT(LCTRL, T),    U_MT(LALT, N),     U_MT(LGUI, B),     \
&kp J,             U_MT(RALT, SLASH), &kp COMMA,         &kp K,             U_LT(U_MEDIA, SQT),U_LT(U_FUN, W),    U_MT(RALT, M),     &kp L,             &kp P,             &kp V,             \
U_NP,              U_NP,              U_LT(U_BRAC, TAB), U_LT(U_NAV, E),    U_LT(U_BNFRD, ESC),U_LT(U_NSYM, RET), U_LT(U_PUNC, SPC), U_NP,              U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAK \
&kp Q,             &kp W,             &kp F,             &kp P,             &kp G,             &kp J,             &kp L,             &kp U,             &kp Y,             &kp SQT,           \
U_MT(LGUI, A),     U_MT(LALT, R),     U_MT(LCTRL, S),    U_MT(LSHFT, T),    &kp D,             &kp H,             U_MT(LSHFT, N),    U_MT(LCTRL, E),    U_MT(LALT, I),     U_MT(LGUI, O),     \
&kp Z,             U_MT(RALT, X),     &kp C,             &kp V,             U_LT(U_MEDIA, B),  U_LT(U_FUN, K),    U_MT(RALT, M),     &kp COMMA,         &kp DOT,           &kp SLASH,         \
U_NP,              U_NP,              U_LT(U_BRAC, TAB), U_LT(U_NAV, E),    U_LT(U_BNFRD, ESC),U_LT(U_NSYM, RET), U_LT(U_PUNC, SPC), U_NP,              U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAKDH \
&kp Q,             &kp W,             &kp F,             &kp P,             &kp B,             &kp J,             &kp L,             &kp U,             &kp Y,             &kp SQT,           \
U_MT(LGUI, A),     U_MT(LALT, R),     U_MT(LCTRL, S),    U_MT(LSHFT, T),    &kp G,             &kp M,             U_MT(LSHFT, N),    U_MT(LCTRL, E),    U_MT(LALT, I),     U_MT(LGUI, O),     \
&kp Z,             U_MT(RALT, X),     &kp C,             &kp D,             U_LT(U_MEDIA, V),  U_LT(U_FUN, K),    U_MT(RALT, H),     &kp COMMA,         &kp DOT,           &kp SLASH,         \
U_NP,              U_NP,              U_LT(U_BRAC, TAB), U_LT(U_NAV, E),    U_LT(U_BNFRD, ESC),U_LT(U_NSYM, RET), U_LT(U_PUNC, SPC), U_NP,              U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAKDHK \
&kp Q,             &kp W,             &kp F,             &kp P,             &kp B,             &kp J,             &kp L,             &kp U,             &kp Y,             &kp SQT,           \
U_MT(LGUI, A),     U_MT(LALT, R),     U_MT(LCTRL, S),    U_MT(LSHFT, T),    &kp G,             &kp K,             U_MT(LSHFT, N),    U_MT(LCTRL, E),    U_MT(LALT, I),     U_MT(LGUI, O),     \
&kp Z,             U_MT(RALT, X),     &kp C,             &kp D,             U_LT(U_MEDIA, V),  U_LT(U_FUN, M),    U_MT(RALT, H),     &kp COMMA,         &kp DOT,           &kp SLASH,         \
U_NP,              U_NP,              U_LT(U_BRAC, TAB), U_LT(U_NAV, E),    U_LT(U_BNFRD, ESC),U_LT(U_NSYM, RET), U_LT(U_PUNC, SPC), U_NP,              U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_DVORAK \
&kp SQT,           &kp COMMA,         &kp DOT,           &kp P,             &kp Y,             &kp F,             &kp G,             &kp C,             &kp R,             &kp L,             \
U_MT(LGUI, A),     U_MT(LALT, O),     U_MT(LCTRL, E),    U_MT(LSHFT, U),    &kp I,             &kp D,             U_MT(LSHFT, H),    U_MT(LCTRL, T),    U_MT(LALT, N),     U_MT(LGUI, S),     \
&kp SLASH,         U_MT(RALT, Q),     &kp J,             &kp K,             U_LT(U_MEDIA, X),  U_LT(U_FUN, B),    U_MT(RALT, M),     &kp W,             &kp V,             &kp Z,             \
U_NP,              U_NP,              U_LT(U_BRAC, TAB), U_LT(U_NAV, E),    U_LT(U_BNFRD, ESC),U_LT(U_NSYM, RET), U_LT(U_PUNC, SPC), U_NP,              U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_HALMAK \
&kp W,             &kp L,             &kp R,             &kp B,             &kp Z,             &kp SQT,           &kp Q,             &kp U,             &kp D,             &kp J,             \
U_MT(LGUI, S),     U_MT(LALT, H),     U_MT(LCTRL, N),    U_MT(LSHFT, T),    &kp COMMA,         &kp DOT,           U_MT(LSHFT, A),    U_MT(LCTRL, E),    U_MT(LALT, O),     U_MT(LGUI, I),     \
&kp F,             U_MT(RALT, M),     &kp V,             &kp C,             U_LT(U_MEDIA, SLASH),U_LT(U_FUN, G),    U_MT(RALT, P),     &kp X,             &kp K,             &kp Y,             \
U_NP,              U_NP,              U_LT(U_BRAC, TAB), U_LT(U_NAV, E),    U_LT(U_BNFRD, ESC),U_LT(U_NSYM, RET), U_LT(U_PUNC, SPC), U_NP,              U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_WORKMAN \
&kp Q,             &kp D,             &kp R,             &kp W,             &kp B,             &kp J,             &kp F,             &kp U,             &kp P,             &kp SQT,           \
U_MT(LGUI, A),     U_MT(LALT, S),     U_MT(LCTRL, H),    U_MT(LSHFT, T),    &kp G,             &kp Y,             U_MT(LSHFT, N),    U_MT(LCTRL, E),    U_MT(LALT, O),     U_MT(LGUI, I),     \
&kp Z,             U_MT(RALT, X),     &kp M,             &kp C,             U_LT(U_MEDIA, V),  U_LT(U_FUN, K),    U_MT(RALT, L),     &kp COMMA,         &kp DOT,           &kp SLASH,         \
U_NP,              U_NP,              U_LT(U_BRAC, TAB), U_LT(U_NAV, E),    U_LT(U_BNFRD, ESC),U_LT(U_NSYM, RET), U_LT(U_PUNC, SPC), U_NP,              U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_QWERTY \
&kp Q,             &kp W,             &kp E,             &kp R,             &kp T,             &kp Y,             &kp U,             &kp I,             &kp O,             &kp P,             \
U_MT(LGUI, A),     U_MT(LALT, S),     U_MT(LCTRL, D),    U_MT(LSHFT, F),    &kp G,             &kp H,             U_MT(LSHFT, J),    U_MT(LCTRL, K),    U_MT(LALT, L),     U_MT(LGUI, SQT),   \
&kp Z,             U_MT(RALT, X),     &kp C,             &kp V,             U_LT(U_MEDIA, B),  U_LT(U_FUN, N),    U_MT(RALT, M),     &kp COMMA,         &kp DOT,           &kp SLASH,         \
U_NP,              U_NP,              U_LT(U_BRAC, TAB), U_LT(U_NAV, E),    U_LT(U_BNFRD, ESC),U_LT(U_NSYM, RET), U_LT(U_PUNC, SPC), U_NP,              U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_QWERTZ \
&kp Q,             &kp W,             &kp E,             &kp R,             &kp T,             &kp Z,             &kp U,             &kp I,             &kp O,             &kp P,             \
U_MT(LGUI, A),     U_MT(LALT, S),     U_MT(LCTRL, D),    U_MT(LSHFT, F),    &kp G,             &kp H,             U_MT(LSHFT, J),    U_MT(LCTRL, K),    U_MT(LALT, L),     U_MT(LGUI, SQT),   \
&kp Y,             U_MT(RALT, X),     &kp C,             &kp V,             U_LT(U_MEDIA, B),  U_LT(U_FUN, N),    U_MT(RALT, M),     &kp COMMA,         &kp DOT,           &kp SLASH,         \
U_NP,              U_NP,              U_LT(U_BRAC, TAB), U_LT(U_NAV, E),    U_LT(U_BNFRD, ESC),U_LT(U_NSYM, RET), U_LT(U_PUNC, SPC), U_NP,              U_NP,              U_NP
...
U_NA,              &kp RALT,          &u_to_U_NUM,       U_NA,              U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              &kp RET,           &kp BSPC,          &kp DEL,           U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_NAV_VI \
U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
&kp LGUI,          &kp LALT,          &kp LCTRL,         &kp LSHFT,         U_NA,              &kp LEFT,          &kp DOWN,          &kp UP,            &kp RIGHT,         &u_caps_word,      \
U_NA,              &kp RALT,          &u_to_U_NUM,       U_NA,              U_NA,              &kp HOME,          &kp PG_DN,         &kp PG_UP,         &kp END,           &kp INS,           \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              &kp RET,           &kp BSPC,          &kp DEL,           U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_NAV \
U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
&kp LGUI,          &kp LALT,          &kp LCTRL,         &kp LSHFT,         U_NA,              &u_caps_word,      &kp LEFT,          &kp DOWN,          &kp UP,            &kp RIGHT,         \
U_NA,              &kp RALT,          &u_to_U_NUM,       U_NA,              U_NA,              &kp INS,           &kp HOME,          &kp PG_DN,         &kp PG_UP,         &kp END,           \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              &kp RET,           &kp BSPC,          &kp DEL,           U_NP,              U_NP
...
U_NA,              &kp RALT,          &u_to_U_SYM,       U_NA,              U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              U_BTN2,            U_BTN1,            U_BTN3,            U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_MOUSE_VI \
U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
&kp LGUI,          &kp LALT,          &kp LCTRL,         &kp LSHFT,         U_NA,              U_MS_L,            U_MS_D,            U_MS_U,            U_MS_R,            U_NU,              \
U_NA,              &kp RALT,          &u_to_U_SYM,       U_NA,              U_NA,              U_WH_L,            U_WH_D,            U_WH_U,            U_WH_R,            U_NU,              \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              U_BTN2,            U_BTN1,            U_BTN3,            U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_MOUSE \
U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
&kp LGUI,          &kp LALT,          &kp LCTRL,         &kp LSHFT,         U_NA,              U_NU,              U_MS_L,            U_MS_D,            U_MS_U,            U_MS_R,            \
U_NA,              &kp RALT,          &u_to_U_SYM,       U_NA,              U_NA,              U_NU,              U_WH_L,            U_WH_D,            U_WH_U,            U_WH_R,            \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              U_BTN2,            U_BTN1,            U_BTN3,            U_NP,              U_NP
...
U_NA,              &kp RALT,          &u_to_U_FUN,       U_NA,              U_NA,              &u_out_tog,        &u_bt_sel_0,       &u_bt_sel_1,       &u_bt_sel_2,       &u_bt_sel_3,       \
...
U_NA,              &kp RALT,          &u_to_U_FUN,       U_NA,              U_NA,              &u_bt_sel_0,       &u_bt_sel_1,       &u_bt_sel_2,       &u_bt_sel_3,       &u_out_tog,        \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              &kp C_STOP,        &kp C_PP,          &kp C_MUTE,        U_NP,              U_NP
...
&kp GRAVE,         &kp NUM_1,         &kp NUM_2,         &kp NUM_3,         &kp BSLH,          U_NA,              &kp RALT,          U_NA,              U_NA,              U_NA,              \
...
&kp TILDE,         &kp EXCL,          &kp AT,            &kp HASH,          &kp PIPE,          U_NA,              &kp RALT,          U_NA,              U_NA,              U_NA,              \
U_NP,              U_NP,              &kp LPAR,          &kp RPAR,          &kp UNDER,         U_NA,              U_NA,              U_NA,              U_NP,              U_NP


#define MIRYOKU_ALTERNATIVES_FUN_FLIP \
U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      U_NA,              &kp PSCRN,         &kp F9,            &kp F8,            &kp F7,            &kp F10,           \
&kp LGUI,          &kp LALT,          &kp LCTRL,         &kp LSHFT,         U_NA,              &kp F4,            &kp F3,            &kp F2,            &kp F1,            &kp F11,           \
U_NA,              &kp RALT,          &u_to_U_MEDIA,     &u_to_U_FUN,       U_NA,              &kp PAUSE_BREAK,   &kp SLCK,          &kp F6,            &kp F5,            &kp F12,           \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              &kp K_APP,         &kp SPC,           &kp TAB,           U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_FUN \
&kp PSCRN,         &kp F9,            &kp F8,            &kp F7,            &kp F10,           U_NA,              &u_to_U_BASE,      &u_to_U_EXTRA,     &u_to_U_TAP,       U_BOOT,            \
&kp F4,            &kp F3,            &kp F2,            &kp F1,            &kp F11,           U_NA,              &kp LSHFT,         &kp LCTRL,         &kp LALT,          &kp LGUI,          \
&kp PAUSE_BREAK,   &kp SLCK,          &kp F6,            &kp F5,            &kp F12,           U_NA,              &kp RALT,          U_NA,              U_NA,              U_NA,              \
U_NP,              U_NP,              &kp TAB,           &kp SPC,           &kp K_APP,         U_NA,              U_NA,              U_NA,              U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BNFRD \
U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      U_NA,              &kp LPAR,          &kp NUM_7,         &kp NUM_8,         &kp NUM_9,         &kp RPAR,          \
&kp LGUI,          &kp LALT,          &kp LCTRL,         &kp LSHFT,         U_NA,              &kp PLUS,          &kp NUM_1,         &kp NUM_2,         &kp NUM_3,         &kp NUM_4,         \
U_NA,              &kp RALT,          &u_to_U_SYM,       U_NA,              U_NA,              &kp MINUS,         &kp NUM_5,         &kp NUM_6,         &kp ASTRK,         &kp SLASH,         \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              &kp SPC,           &kp NUM_0,         &kp DOT,           U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_NSYM \
U_RGB_TOG,         U_NU,              U_NU,              &kp DLLR,          U_NU,              U_NA,              &u_to_U_BASE,      &u_to_U_EXTRA,     &u_to_U_TAP,       U_BOOT,            \
&kp ASTRK,         &kp SLASH,         &kp MINUS,         &kp PLUS,          U_NU,              U_NA,              &kp LSHFT,         &kp LCTRL,         &kp LALT,          &kp LGUI,          \
U_NU,              U_NU,              &kp PRCT,          &kp HASH,          U_NU,              U_NA,              &kp RALT,          U_NA,              U_NA,              U_NA,              \
U_NP,              U_NP,              &kp CRRT,          &kp EQL,           &kp UNDER,         U_NA,              U_NA,              U_NA,              U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BRAC \
U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      U_NA,              U_NU,              &kp RPAR,          &kp RBKT,          &kp GT,            &kp RBRC,          \
&kp LGUI,          &kp LALT,          &kp LCTRL,         &kp LSHFT,         U_NA,              U_NU,              &kp LPAR,          &kp LBKT,          &kp LT,            &kp LBRC,          \
U_NA,              &kp RALT,          &u_to_U_SYM,       U_NA,              U_NA,              U_NU,              &kp RPAR,          &kp RBKT,          &kp GT,            &kp RBRC,          \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              &kp UNDER,         &kp EQL,           U_NU,              U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_PUNC \
U_NU,              &kp GRAVE,         &kp AT,            &kp TILDE,         U_NU,              U_NA,              &u_to_U_BASE,      &u_to_U_EXTRA,     &u_to_U_TAP,       U_BOOT,            \
&kp QMARK,         &kp EXCL,          &kp DQT,           &kp SQT,           U_NU,              U_NA,              &kp LSHFT,         &kp LCTRL,         &kp LALT,          &kp LGUI,          \
U_NU,              U_NU,              &kp AMPS,          &kp BSLH,          U_NU,              U_NA,              &kp RALT,          U_NA,              U_NA,              U_NA,              \
U_NP,              U_NP,              &kp PIPE,          &kp SEMI,          &kp COLON,         U_NA,              U_NA,              U_NA,              U_NP,              U_NP
