...
U_NP,              U_NP,              LT(U_FUN,KC_BSPC), LT(U_NUM,KC_SPC),  LT(U_SYM,KC_ENT),  LT(U_MOUSE,KC_ESC),LT(U_NAV,KC_E),    LT(U_MEDIA,KC_TAB),U_NP,              U_NP
...
KC_A,              KC_Z,              KC_E,              KC_R,              KC_T,              KC_Y,              KC_U,              KC_I,              KC_O,              KC_P,              \
LGUI_T(KC_Q),      LALT_T(KC_S),      LCTL_T(KC_D),      LSFT_T(KC_F),      KC_G,              KC_H,              LSFT_T(KC_J),      LCTL_T(KC_K),      LALT_T(KC_L),      LGUI_T(KC_M),      \
KC_W,              ALGR_T(KC_X),      KC_C,              KC_V,              LT(U_FUN,KC_B),    KC_N,              KC_COMM,           KC_DOT,            ALGR_T(KC_SLSH),   KC_QUOT,           \
...
KC_Q,              KC_H,              KC_O,              KC_U,              KC_X,              KC_G,              KC_C,              KC_R,              KC_F,              KC_Z,              \
LGUI_T(KC_Y),      LALT_T(KC_I),      LCTL_T(KC_E),      LSFT_T(KC_A),      KC_DOT,            KC_D,              LSFT_T(KC_S),      LCTL_T(KC_T),      LALT_T(KC_N),      LGUI_T(KC_B),      \
KC_J,              ALGR_T(KC_SLSH),   KC_COMM,           KC_K,              LT(U_FUN,KC_QUOT), KC_W,              KC_M,              KC_L,              ALGR_T(KC_P),      KC_V,              \
U_NP,              U_NP,              LT(U_MEDIA,KC_TAB),LT(U_NAV,KC_E),    LT(U_BNFRD,KC_ESC),LT(U_NSYM,KC_ENT), LT(U_PUNC,KC_SPC), LT(U_BRAC,KC_BSPC),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAK \
KC_Q,              KC_W,              KC_F,              KC_P,              KC_G,              KC_J,              KC_L,              KC_U,              KC_Y,              KC_QUOT,           \
LGUI_T(KC_A),      LALT_T(KC_R),      LCTL_T(KC_S),      LSFT_T(KC_T),      KC_D,              KC_H,              LSFT_T(KC_N),      LCTL_T(KC_E),      LALT_T(KC_I),      LGUI_T(KC_O),      \
KC_Z,              ALGR_T(KC_X),      KC_C,              KC_V,              LT(U_FUN,KC_B),    KC_K,              KC_M,              KC_COMM,           ALGR_T(KC_DOT),    KC_SLSH,           \
U_NP,              U_NP,              LT(U_MEDIA,KC_TAB),LT(U_NAV,KC_E),    LT(U_BNFRD,KC_ESC),LT(U_NSYM,KC_ENT), LT(U_PUNC,KC_SPC), LT(U_BRAC,KC_BSPC),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAKDH \
KC_Q,              KC_W,              KC_F,              KC_P,              KC_B,              KC_J,              KC_L,              KC_U,              KC_Y,              KC_QUOT,           \
LGUI_T(KC_A),      LALT_T(KC_R),      LCTL_T(KC_S),      LSFT_T(KC_T),      KC_G,              KC_M,              LSFT_T(KC_N),      LCTL_T(KC_E),      LALT_T(KC_I),      LGUI_T(KC_O),      \
KC_Z,              ALGR_T(KC_X),      KC_C,              KC_D,              LT(U_FUN,KC_V),    KC_K,              KC_H,              KC_COMM,           ALGR_T(KC_DOT),    KC_SLSH,           \
U_NP,              U_NP,              LT(U_MEDIA,KC_TAB),LT(U_NAV,KC_E),    LT(U_BNFRD,KC_ESC),LT(U_NSYM,KC_ENT), LT(U_PUNC,KC_SPC), LT(U_BRAC,KC_BSPC),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAKDHK \
KC_Q,              KC_W,              KC_F,              KC_P,              KC_B,              KC_J,              KC_L,              KC_U,              KC_Y,              KC_QUOT,           \
LGUI_T(KC_A),      LALT_T(KC_R),      LCTL_T(KC_S),      LSFT_T(KC_T),      KC_G,              KC_K,              LSFT_T(KC_N),      LCTL_T(KC_E),      LALT_T(KC_I),      LGUI_T(KC_O),      \
KC_Z,              ALGR_T(KC_X),      KC_C,              KC_D,              LT(U_FUN,KC_V),    KC_M,              KC_H,              KC_COMM,           ALGR_T(KC_DOT),    KC_SLSH,           \
U_NP,              U_NP,              LT(U_MEDIA,KC_TAB),LT(U_NAV,KC_E),    LT(U_BNFRD,KC_ESC),LT(U_NSYM,KC_ENT), LT(U_PUNC,KC_SPC), LT(U_BRAC,KC_BSPC),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_DVORAK \
KC_QUOT,           KC_COMM,           KC_DOT,            KC_P,              KC_Y,              KC_F,              KC_G,              KC_C,              KC_R,              KC_L,              \
LGUI_T(KC_A),      LALT_T(KC_O),      LCTL_T(KC_E),      LSFT_T(KC_U),      KC_I,              KC_D,              LSFT_T(KC_H),      LCTL_T(KC_T),      LALT_T(KC_N),      LGUI_T(KC_S),      \
KC_SLSH,           ALGR_T(KC_Q),      KC_J,              KC_K,              LT(U_FUN,KC_X),    KC_B,              KC_M,              KC_W,              ALGR_T(KC_V),      KC_Z,              \
U_NP,              U_NP,              LT(U_MEDIA,KC_TAB),LT(U_NAV,KC_E),    LT(U_BNFRD,KC_ESC),LT(U_NSYM,KC_ENT), LT(U_PUNC,KC_SPC), LT(U_BRAC,KC_BSPC),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_HALMAK \
KC_W,              KC_L,              KC_R,              KC_B,              KC_Z,              KC_QUOT,           KC_Q,              KC_U,              KC_D,              KC_J,              \
LGUI_T(KC_S),      LALT_T(KC_H),      LCTL_T(KC_N),      LSFT_T(KC_T),      KC_COMM,           KC_DOT,            LSFT_T(KC_A),      LCTL_T(KC_E),      LALT_T(KC_O),      LGUI_T(KC_I),      \
KC_F,              ALGR_T(KC_M),      KC_V,              KC_C,              LT(U_FUN,KC_SLSH), KC_G,              KC_P,              KC_X,              ALGR_T(KC_K),      KC_Y,              \
U_NP,              U_NP,              LT(U_MEDIA,KC_TAB),LT(U_NAV,KC_E),    LT(U_BNFRD,KC_ESC),LT(U_NSYM,KC_ENT), LT(U_PUNC,KC_SPC), LT(U_BRAC,KC_BSPC),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_WORKMAN \
KC_Q,              KC_D,              KC_R,              KC_W,              KC_B,              KC_J,              KC_F,              KC_U,              KC_P,              KC_QUOT,           \
LGUI_T(KC_A),      LALT_T(KC_S),      LCTL_T(KC_H),      LSFT_T(KC_T),      KC_G,              KC_Y,              LSFT_T(KC_N),      LCTL_T(KC_E),      LALT_T(KC_O),      LGUI_T(KC_I),      \
KC_Z,              ALGR_T(KC_X),      KC_M,              KC_C,              LT(U_FUN,KC_V),    KC_K,              KC_L,              KC_COMM,           ALGR_T(KC_DOT),    KC_SLSH,           \
U_NP,              U_NP,              LT(U_MEDIA,KC_TAB),LT(U_NAV,KC_E),    LT(U_BNFRD,KC_ESC),LT(U_NSYM,KC_ENT), LT(U_PUNC,KC_SPC), LT(U_BRAC,KC_BSPC),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_QWERTY \
KC_Q,              KC_W,              KC_E,              KC_R,              KC_T,              KC_Y,              KC_U,              KC_I,              KC_O,              KC_P,              \
LGUI_T(KC_A),      LALT_T(KC_S),      LCTL_T(KC_D),      LSFT_T(KC_F),      KC_G,              KC_H,              LSFT_T(KC_J),      LCTL_T(KC_K),      LALT_T(KC_L),      LGUI_T(KC_QUOT),   \
KC_Z,              ALGR_T(KC_X),      KC_C,              KC_V,              LT(U_FUN,KC_B),    KC_N,              KC_M,              KC_COMM,           ALGR_T(KC_DOT),    KC_SLSH,           \
U_NP,              U_NP,              LT(U_MEDIA,KC_TAB),LT(U_NAV,KC_E),    LT(U_BNFRD,KC_ESC),LT(U_NSYM,KC_ENT), LT(U_PUNC,KC_SPC), LT(U_BRAC,KC_BSPC),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_QWERTZ \
KC_Q,              KC_W,              KC_E,              KC_R,              KC_T,              KC_Z,              KC_U,              KC_I,              KC_O,              KC_P,              \
LGUI_T(KC_A),      LALT_T(KC_S),      LCTL_T(KC_D),      LSFT_T(KC_F),      KC_G,              KC_H,              LSFT_T(KC_J),      LCTL_T(KC_K),      LALT_T(KC_L),      LGUI_T(KC_QUOT),   \
KC_Y,              ALGR_T(KC_X),      KC_C,              KC_V,              LT(U_FUN,KC_B),    KC_N,              KC_M,              KC_COMM,           ALGR_T(KC_DOT),    KC_SLSH,           \
U_NP,              U_NP,              LT(U_MEDIA,KC_TAB),LT(U_NAV,KC_E),    LT(U_BNFRD,KC_ESC),LT(U_NSYM,KC_ENT), LT(U_PUNC,KC_SPC), LT(U_BRAC,KC_BSPC),U_NP,              U_NP
...
U_NP,              U_NP,              KC_BSPC,           KC_SPC,            KC_ENT,            KC_ESC,            KC_E,              KC_TAB,            U_NP,              U_NP
...
QK_BOOT,           DF(U_TAP),         DF(U_EXTRA),       DF(U_BASE),        U_NA,              OUT_AUTO,          RGB_TOG,           RGB_HUI,           RGB_SAI,           RGB_VAI,           \
KC_LGUI,           KC_LALT,           KC_LCTL,           KC_LSFT,           U_NA,              U_NU,              KC_MPRV,           KC_VOLD,           KC_VOLU,           KC_MNXT,           \
U_NA,              KC_ALGR,           DF(U_FUN),         DF(U_MEDIA),       U_NA,              U_NU,              U_NU,              U_NU,              U_NU,              U_NU,              \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              KC_MSTP,           KC_MPLY,           KC_MUTE,           U_NP,              U_NP
