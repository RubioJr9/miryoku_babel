...
KC_A,              KC_Z,              KC_E,              KC_R,              KC_T,              KC_Y,              KC_U,              KC_I,              KC_O,              KC_P,              \
LGUI_T(KC_Q),      LALT_T(KC_S),      LCTL_T(KC_D),      LSFT_T(KC_F),      KC_G,              KC_H,              LSFT_T(KC_J),      LCTL_T(KC_K),      LALT_T(KC_L),      LGUI_T(KC_M),      \
KC_W,              ALGR_T(KC_X),      KC_C,              KC_V,              LT(U_MEDIA,KC_B),  LT(U_FUN,KC_N),    ALGR_T(KC_COMM),   KC_DOT,            KC_SLSH,           KC_QUOT,           \
U_NP,              U_NP,              LT(U_BRAC,KC_TAB), LT(U_NAV,KC_E),    LT(U_BNFRD,KC_ESC),LT(U_NSYM,KC_ENT), LT(U_PUNC,KC_SPC), U_NP,              U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_BEAKL15 \
KC_Q,              KC_H,              KC_O,              KC_U,              KC_X,              KC_G,              KC_C,              KC_R,              KC_F,              KC_Z,              \
LGUI_T(KC_Y),      LALT_T(KC_I),      LCTL_T(KC_E),      LSFT_T(KC_A),      KC_DOT,            KC_D,              LSFT_T(KC_S),      LCTL_T(KC_T),      LALT_T(KC_N),      LGUI_T(KC_B),      \
KC_J,              ALGR_T(KC_SLSH),   KC_COMM,           KC_K,              LT(U_MEDIA,KC_QUOT),LT(U_FUN,KC_W),    ALGR_T(KC_M),      KC_L,              KC_P,              KC_V,              \
U_NP,              U_NP,              LT(U_BRAC,KC_TAB), LT(U_NAV,KC_E),    LT(U_BNFRD,KC_ESC),LT(U_NSYM,KC_ENT), LT(U_PUNC,KC_SPC), U_NP,              U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAK \
KC_Q,              KC_W,              KC_F,              KC_P,              KC_G,              KC_J,              KC_L,              KC_U,              KC_Y,              KC_QUOT,           \
LGUI_T(KC_A),      LALT_T(KC_R),      LCTL_T(KC_S),      LSFT_T(KC_T),      KC_D,              KC_H,              LSFT_T(KC_N),      LCTL_T(KC_E),      LALT_T(KC_I),      LGUI_T(KC_O),      \
KC_Z,              ALGR_T(KC_X),      KC_C,              KC_V,              LT(U_MEDIA,KC_B),  LT(U_FUN,KC_K),    ALGR_T(KC_M),      KC_COMM,           KC_DOT,            KC_SLSH,           \
U_NP,              U_NP,              LT(U_BRAC,KC_TAB), LT(U_NAV,KC_E),    LT(U_BNFRD,KC_ESC),LT(U_NSYM,KC_ENT), LT(U_PUNC,KC_SPC), U_NP,              U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAKDH \
KC_Q,              KC_W,              KC_F,              KC_P,              KC_B,              KC_J,              KC_L,              KC_U,              KC_Y,              KC_QUOT,           \
LGUI_T(KC_A),      LALT_T(KC_R),      LCTL_T(KC_S),      LSFT_T(KC_T),      KC_G,              KC_M,              LSFT_T(KC_N),      LCTL_T(KC_E),      LALT_T(KC_I),      LGUI_T(KC_O),      \
KC_Z,              ALGR_T(KC_X),      KC_C,              KC_D,              LT(U_MEDIA,KC_V),  LT(U_FUN,KC_K),    ALGR_T(KC_H),      KC_COMM,           KC_DOT,            KC_SLSH,           \
U_NP,              U_NP,              LT(U_BRAC,KC_TAB), LT(U_NAV,KC_E),    LT(U_BNFRD,KC_ESC),LT(U_NSYM,KC_ENT), LT(U_PUNC,KC_SPC), U_NP,              U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAKDHK \
KC_Q,              KC_W,              KC_F,              KC_P,              KC_B,              KC_J,              KC_L,              KC_U,              KC_Y,              KC_QUOT,           \
LGUI_T(KC_A),      LALT_T(KC_R),      LCTL_T(KC_S),      LSFT_T(KC_T),      KC_G,              KC_K,              LSFT_T(KC_N),      LCTL_T(KC_E),      LALT_T(KC_I),      LGUI_T(KC_O),      \
KC_Z,              ALGR_T(KC_X),      KC_C,              KC_D,              LT(U_MEDIA,KC_V),  LT(U_FUN,KC_M),    ALGR_T(KC_H),      KC_COMM,           KC_DOT,            KC_SLSH,           \
U_NP,              U_NP,              LT(U_BRAC,KC_TAB), LT(U_NAV,KC_E),    LT(U_BNFRD,KC_ESC),LT(U_NSYM,KC_ENT), LT(U_PUNC,KC_SPC), U_NP,              U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_DVORAK \
KC_QUOT,           KC_COMM,           KC_DOT,            KC_P,              KC_Y,              KC_F,              KC_G,              KC_C,              KC_R,              KC_L,              \
LGUI_T(KC_A),      LALT_T(KC_O),      LCTL_T(KC_E),      LSFT_T(KC_U),      KC_I,              KC_D,              LSFT_T(KC_H),      LCTL_T(KC_T),      LALT_T(KC_N),      LGUI_T(KC_S),      \
KC_SLSH,           ALGR_T(KC_Q),      KC_J,              KC_K,              LT(U_MEDIA,KC_X),  LT(U_FUN,KC_B),    ALGR_T(KC_M),      KC_W,              KC_V,              KC_Z,              \
U_NP,              U_NP,              LT(U_BRAC,KC_TAB), LT(U_NAV,KC_E),    LT(U_BNFRD,KC_ESC),LT(U_NSYM,KC_ENT), LT(U_PUNC,KC_SPC), U_NP,              U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_HALMAK \
KC_W,              KC_L,              KC_R,              KC_B,              KC_Z,              KC_QUOT,           KC_Q,              KC_U,              KC_D,              KC_J,              \
LGUI_T(KC_S),      LALT_T(KC_H),      LCTL_T(KC_N),      LSFT_T(KC_T),      KC_COMM,           KC_DOT,            LSFT_T(KC_A),      LCTL_T(KC_E),      LALT_T(KC_O),      LGUI_T(KC_I),      \
KC_F,              ALGR_T(KC_M),      KC_V,              KC_C,              LT(U_MEDIA,KC_SLSH),LT(U_FUN,KC_G),    ALGR_T(KC_P),      KC_X,              KC_K,              KC_Y,              \
U_NP,              U_NP,              LT(U_BRAC,KC_TAB), LT(U_NAV,KC_E),    LT(U_BNFRD,KC_ESC),LT(U_NSYM,KC_ENT), LT(U_PUNC,KC_SPC), U_NP,              U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_WORKMAN \
KC_Q,              KC_D,              KC_R,              KC_W,              KC_B,              KC_J,              KC_F,              KC_U,              KC_P,              KC_QUOT,           \
LGUI_T(KC_A),      LALT_T(KC_S),      LCTL_T(KC_H),      LSFT_T(KC_T),      KC_G,              KC_Y,              LSFT_T(KC_N),      LCTL_T(KC_E),      LALT_T(KC_O),      LGUI_T(KC_I),      \
KC_Z,              ALGR_T(KC_X),      KC_M,              KC_C,              LT(U_MEDIA,KC_V),  LT(U_FUN,KC_K),    ALGR_T(KC_L),      KC_COMM,           KC_DOT,            KC_SLSH,           \
U_NP,              U_NP,              LT(U_BRAC,KC_TAB), LT(U_NAV,KC_E),    LT(U_BNFRD,KC_ESC),LT(U_NSYM,KC_ENT), LT(U_PUNC,KC_SPC), U_NP,              U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_QWERTY \
KC_Q,              KC_W,              KC_E,              KC_R,              KC_T,              KC_Y,              KC_U,              KC_I,              KC_O,              KC_P,              \
LGUI_T(KC_A),      LALT_T(KC_S),      LCTL_T(KC_D),      LSFT_T(KC_F),      KC_G,              KC_H,              LSFT_T(KC_J),      LCTL_T(KC_K),      LALT_T(KC_L),      LGUI_T(KC_QUOT),   \
KC_Z,              ALGR_T(KC_X),      KC_C,              KC_V,              LT(U_MEDIA,KC_B),  LT(U_FUN,KC_N),    ALGR_T(KC_M),      KC_COMM,           KC_DOT,            KC_SLSH,           \
U_NP,              U_NP,              LT(U_BRAC,KC_TAB), LT(U_NAV,KC_E),    LT(U_BNFRD,KC_ESC),LT(U_NSYM,KC_ENT), LT(U_PUNC,KC_SPC), U_NP,              U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_QWERTZ \
KC_Q,              KC_W,              KC_E,              KC_R,              KC_T,              KC_Z,              KC_U,              KC_I,              KC_O,              KC_P,              \
LGUI_T(KC_A),      LALT_T(KC_S),      LCTL_T(KC_D),      LSFT_T(KC_F),      KC_G,              KC_H,              LSFT_T(KC_J),      LCTL_T(KC_K),      LALT_T(KC_L),      LGUI_T(KC_QUOT),   \
KC_Y,              ALGR_T(KC_X),      KC_C,              KC_V,              LT(U_MEDIA,KC_B),  LT(U_FUN,KC_N),    ALGR_T(KC_M),      KC_COMM,           KC_DOT,            KC_SLSH,           \
U_NP,              U_NP,              LT(U_BRAC,KC_TAB), LT(U_NAV,KC_E),    LT(U_BNFRD,KC_ESC),LT(U_NSYM,KC_ENT), LT(U_PUNC,KC_SPC), U_NP,              U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_RSTHP \
KC_DEL,            KC_C,              KC_Y,              KC_F,              KC_K,              KC_Z,              KC_L,              KC_COMM,           KC_U,              KC_Q,              \
LGUI_T(KC_R),      LALT_T(KC_S),      LCTL_T(KC_T),      LSFT_T(KC_H),      KC_P,              KC_W,              LSFT_T(KC_N),      LCTL_T(KC_A),      LALT_T(KC_I),      LGUI_T(KC_O),      \
KC_J,              ALGR_T(KC_V),      KC_G,              KC_D,              LT(U_MEDIA,KC_B),  LT(U_FUN,KC_X),    ALGR_T(KC_M),      KC_DOT,            KC_BSPC,           TG(TRACKBALL),     \
U_NP,              U_NP,              LT(U_BRAC,KC_TAB), LT(U_NAV,KC_E),    LT(U_BNFRD,KC_ESC),LT(U_NSYM,KC_ENT), LT(U_PUNC,KC_SPC), U_NP,              U_NP,              U_NP
...
KC_Q,              KC_S,              KC_D,              KC_F,              KC_G,              KC_H,              KC_J,              KC_K,              KC_L,              KC_M,              \
KC_W,              KC_X,              KC_C,              KC_V,              KC_B,              KC_N,              KC_COMM,           KC_DOT,            KC_SLSH,           KC_QUOT,           \
U_NP,              U_NP,              KC_TAB,            KC_E,              KC_ESC,            KC_ENT,            KC_SPC,            U_NP,              U_NP,              U_NP
...
KC_DEL,            KC_C,              KC_Y,              KC_F,              KC_K,              KC_Z,              KC_L,              KC_COMM,           KC_U,              KC_Q,              \
KC_R,              KC_S,              KC_T,              KC_H,              KC_P,              KC_W,              KC_N,              KC_A,              KC_I,              KC_O,              \
KC_J,              KC_V,              KC_G,              KC_D,              KC_B,              KC_X,              KC_M,              KC_DOT,            KC_BSPC,           TG(TRACKBALL),     \
U_NP,              U_NP,              KC_TAB,            KC_E,              KC_ESC,            KC_ENT,            KC_SPC,            U_NP,              U_NP,              U_NP
...
U_NA,              KC_ALGR,           TD(U_TD_U_NUM),    U_NA,              U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              KC_ENT,            KC_BSPC,           KC_DEL,            U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_NAV_VI \
TD(U_TD_BOOT),     TD(U_TD_U_TAP),    TD(U_TD_U_EXTRA),  TD(U_TD_U_BASE),   U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
KC_LGUI,           KC_LALT,           KC_LCTL,           KC_LSFT,           U_NA,              KC_LEFT,           KC_DOWN,           KC_UP,             KC_RGHT,           CW_TOGG,           \
U_NA,              KC_ALGR,           TD(U_TD_U_NUM),    U_NA,              U_NA,              KC_HOME,           KC_PGDN,           KC_PGUP,           KC_END,            KC_INS,            \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              KC_ENT,            KC_BSPC,           KC_DEL,            U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_NAV \
TD(U_TD_BOOT),     TD(U_TD_U_TAP),    TD(U_TD_U_EXTRA),  TD(U_TD_U_BASE),   U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
KC_LGUI,           KC_LALT,           KC_LCTL,           KC_LSFT,           U_NA,              CW_TOGG,           KC_LEFT,           KC_DOWN,           KC_UP,             KC_RGHT,           \
U_NA,              KC_ALGR,           TD(U_TD_U_NUM),    U_NA,              U_NA,              KC_INS,            KC_HOME,           KC_PGDN,           KC_PGUP,           KC_END,            \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              KC_ENT,            KC_BSPC,           KC_DEL,            U_NP,              U_NP
...
U_NA,              KC_ALGR,           TD(U_TD_U_SYM),    U_NA,              U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              KC_BTN2,           KC_BTN1,           KC_BTN3,           U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_MOUSE_VI \
TD(U_TD_BOOT),     TD(U_TD_U_TAP),    TD(U_TD_U_EXTRA),  TD(U_TD_U_BASE),   U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
KC_LGUI,           KC_LALT,           KC_LCTL,           KC_LSFT,           U_NA,              KC_MS_L,           KC_MS_D,           KC_MS_U,           KC_MS_R,           U_NU,              \
U_NA,              KC_ALGR,           TD(U_TD_U_SYM),    U_NA,              U_NA,              KC_WH_L,           KC_WH_D,           KC_WH_U,           KC_WH_R,           U_NU,              \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              KC_BTN2,           KC_BTN1,           KC_BTN3,           U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_MOUSE \
TD(U_TD_BOOT),     TD(U_TD_U_TAP),    TD(U_TD_U_EXTRA),  TD(U_TD_U_BASE),   U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
KC_LGUI,           KC_LALT,           KC_LCTL,           KC_LSFT,           U_NA,              U_NU,              KC_MS_L,           KC_MS_D,           KC_MS_U,           KC_MS_R,           \
U_NA,              KC_ALGR,           TD(U_TD_U_SYM),    U_NA,              U_NA,              U_NU,              KC_WH_L,           KC_WH_D,           KC_WH_U,           KC_WH_R,           \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              KC_BTN2,           KC_BTN1,           KC_BTN3,           U_NP,              U_NP
...
U_NA,              KC_ALGR,           TD(U_TD_U_FUN),    U_NA,              U_NA,              OU_AUTO,           U_NU,              U_NU,              U_NU,              U_NU,              \
...
U_NA,              KC_ALGR,           TD(U_TD_U_FUN),    U_NA,              U_NA,              U_NU,              U_NU,              U_NU,              U_NU,              OU_AUTO,           \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              KC_MSTP,           KC_MPLY,           KC_MUTE,           U_NP,              U_NP
...
KC_GRV,            KC_1,              KC_2,              KC_3,              KC_BSLS,           U_NA,              KC_ALGR,           U_NA,              U_NA,              U_NA,              \
...
KC_TILD,           KC_EXLM,           KC_AT,             KC_HASH,           KC_PIPE,           U_NA,              KC_ALGR,           U_NA,              U_NA,              U_NA,              \
U_NP,              U_NP,              KC_LPRN,           KC_RPRN,           KC_UNDS,           U_NA,              U_NA,              U_NA,              U_NP,              U_NP


#define MIRYOKU_ALTERNATIVES_FUN_FLIP \
TD(U_TD_BOOT),     TD(U_TD_U_TAP),    TD(U_TD_U_EXTRA),  TD(U_TD_U_BASE),   U_NA,              KC_PSCR,           KC_F9,             KC_F8,             KC_F7,             KC_F10,            \
KC_LGUI,           KC_LALT,           KC_LCTL,           KC_LSFT,           U_NA,              KC_F4,             KC_F3,             KC_F2,             KC_F1,             KC_F11,            \
U_NA,              KC_ALGR,           TD(U_TD_U_MEDIA),  TD(U_TD_U_FUN),    U_NA,              KC_PAUS,           KC_SCRL,           KC_F6,             KC_F5,             KC_F12,            \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              KC_APP,            KC_SPC,            KC_TAB,            U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_FUN \
KC_PSCR,           KC_F9,             KC_F8,             KC_F7,             KC_F10,            U_NA,              TD(U_TD_U_BASE),   TD(U_TD_U_EXTRA),  TD(U_TD_U_TAP),    TD(U_TD_BOOT),     \
KC_F4,             KC_F3,             KC_F2,             KC_F1,             KC_F11,            U_NA,              KC_LSFT,           KC_LCTL,           KC_LALT,           KC_LGUI,           \
KC_PAUS,           KC_SCRL,           KC_F6,             KC_F5,             KC_F12,            U_NA,              KC_ALGR,           U_NA,              U_NA,              U_NA,              \
U_NP,              U_NP,              KC_TAB,            KC_SPC,            KC_APP,            U_NA,              U_NA,              U_NA,              U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BNFRD \
TD(U_TD_BOOT),     TD(U_TD_U_TAP),    TD(U_TD_U_EXTRA),  TD(U_TD_U_BASE),   U_NA,              KC_LPRN,           KC_7,              KC_8,              KC_9,              KC_RPRN,           \
KC_LGUI,           KC_LALT,           KC_LCTL,           KC_LSFT,           U_NA,              KC_PLUS,           KC_1,              KC_2,              KC_3,              KC_4,              \
U_NA,              KC_ALGR,           TD(U_TD_U_SYM),    U_NA,              U_NA,              KC_MINS,           KC_5,              KC_6,              KC_ASTR,           KC_SLSH,           \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              KC_SPC,            KC_0,              KC_DOT,            U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_NSYM \
RGB_TOG,           U_NU,              U_NU,              KC_DLR,            U_NU,              U_NA,              TD(U_TD_U_BASE),   TD(U_TD_U_EXTRA),  TD(U_TD_U_TAP),    TD(U_TD_BOOT),     \
KC_ASTR,           KC_SLSH,           KC_MINS,           KC_PLUS,           U_NU,              U_NA,              KC_LSFT,           KC_LCTL,           KC_LALT,           KC_LGUI,           \
U_NU,              U_NU,              KC_PERC,           KC_HASH,           U_NU,              U_NA,              KC_ALGR,           U_NA,              U_NA,              U_NA,              \
U_NP,              U_NP,              KC_CIRC,           KC_EQL,            KC_UNDS,           U_NA,              U_NA,              U_NA,              U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BRAC \
TD(U_TD_BOOT),     TD(U_TD_U_TAP),    TD(U_TD_U_EXTRA),  TD(U_TD_U_BASE),   U_NA,              U_NU,              KC_RPRN,           KC_RBRC,           KC_GT,             KC_RCBR,           \
KC_LGUI,           KC_LALT,           KC_LCTL,           KC_LSFT,           U_NA,              U_NU,              KC_LPRN,           KC_LBRC,           KC_LT,             KC_LCBR,           \
U_NA,              KC_ALGR,           TD(U_TD_U_SYM),    U_NA,              U_NA,              U_NU,              KC_RPRN,           KC_RBRC,           KC_GT,             KC_RCBR,           \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              KC_UNDS,           KC_EQL,            U_NU,              U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_PUNC \
U_NU,              KC_GRV,            KC_AT,             KC_TILD,           U_NU,              U_NA,              TD(U_TD_U_BASE),   TD(U_TD_U_EXTRA),  TD(U_TD_U_TAP),    TD(U_TD_BOOT),     \
KC_QUES,           KC_EXLM,           KC_DQUO,           KC_QUOT,           U_NU,              U_NA,              KC_LSFT,           KC_LCTL,           KC_LALT,           KC_LGUI,           \
U_NU,              U_NU,              KC_AMPR,           KC_BSLS,           U_NU,              U_NA,              KC_ALGR,           U_NA,              U_NA,              U_NA,              \
U_NP,              U_NP,              KC_PIPE,           KC_SCLN,           KC_COLN,           U_NA,              U_NA,              U_NA,              U_NP,              U_NP
