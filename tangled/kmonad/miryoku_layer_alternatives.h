...
a,                 z,                 e,                 r,                 t,                 y,                 u,                 i,                 o,                 p,                 \
U_MT(q, met),      U_MT(s, alt),      U_MT(d, ctl),      U_MT(f, sft),      g,                 h,                 U_MT(j, sft),      U_MT(k, ctl),      U_MT(l, alt),      U_MT(m, met),      \
w,                 U_MT(x, ralt),     c,                 v,                 U_LT(b, U_MEDIA),  U_LT(n, U_FUN),    U_MT(U_COMM, ralt),.,                 /,                 U_QUOT,            \
U_NP,              U_NP,              U_LT(tab, U_BRAC), U_LT(e, U_NAV),    U_LT(esc, U_BNFRD),U_LT(ent, U_NSYM), U_LT(spc, U_PUNC), U_NP,              U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_BEAKL15 \
q,                 h,                 o,                 u,                 x,                 g,                 c,                 r,                 f,                 z,                 \
U_MT(y, met),      U_MT(i, alt),      U_MT(e, ctl),      U_MT(a, sft),      .,                 d,                 U_MT(s, sft),      U_MT(t, ctl),      U_MT(n, alt),      U_MT(b, met),      \
j,                 U_MT(/, ralt),     U_COMM,            k,                 U_LT(U_QUOT, U_MEDIA),U_LT(w, U_FUN),    U_MT(m, ralt),     l,                 p,                 v,                 \
U_NP,              U_NP,              U_LT(tab, U_BRAC), U_LT(e, U_NAV),    U_LT(esc, U_BNFRD),U_LT(ent, U_NSYM), U_LT(spc, U_PUNC), U_NP,              U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAK \
q,                 w,                 f,                 p,                 g,                 j,                 l,                 u,                 y,                 U_QUOT,            \
U_MT(a, met),      U_MT(r, alt),      U_MT(s, ctl),      U_MT(t, sft),      d,                 h,                 U_MT(n, sft),      U_MT(e, ctl),      U_MT(i, alt),      U_MT(o, met),      \
z,                 U_MT(x, ralt),     c,                 v,                 U_LT(b, U_MEDIA),  U_LT(k, U_FUN),    U_MT(m, ralt),     U_COMM,            .,                 /,                 \
U_NP,              U_NP,              U_LT(tab, U_BRAC), U_LT(e, U_NAV),    U_LT(esc, U_BNFRD),U_LT(ent, U_NSYM), U_LT(spc, U_PUNC), U_NP,              U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAKDH \
q,                 w,                 f,                 p,                 b,                 j,                 l,                 u,                 y,                 U_QUOT,            \
U_MT(a, met),      U_MT(r, alt),      U_MT(s, ctl),      U_MT(t, sft),      g,                 m,                 U_MT(n, sft),      U_MT(e, ctl),      U_MT(i, alt),      U_MT(o, met),      \
z,                 U_MT(x, ralt),     c,                 d,                 U_LT(v, U_MEDIA),  U_LT(k, U_FUN),    U_MT(h, ralt),     U_COMM,            .,                 /,                 \
U_NP,              U_NP,              U_LT(tab, U_BRAC), U_LT(e, U_NAV),    U_LT(esc, U_BNFRD),U_LT(ent, U_NSYM), U_LT(spc, U_PUNC), U_NP,              U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAKDHK \
q,                 w,                 f,                 p,                 b,                 j,                 l,                 u,                 y,                 U_QUOT,            \
U_MT(a, met),      U_MT(r, alt),      U_MT(s, ctl),      U_MT(t, sft),      g,                 k,                 U_MT(n, sft),      U_MT(e, ctl),      U_MT(i, alt),      U_MT(o, met),      \
z,                 U_MT(x, ralt),     c,                 d,                 U_LT(v, U_MEDIA),  U_LT(m, U_FUN),    U_MT(h, ralt),     U_COMM,            .,                 /,                 \
U_NP,              U_NP,              U_LT(tab, U_BRAC), U_LT(e, U_NAV),    U_LT(esc, U_BNFRD),U_LT(ent, U_NSYM), U_LT(spc, U_PUNC), U_NP,              U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_DVORAK \
U_QUOT,            U_COMM,            .,                 p,                 y,                 f,                 g,                 c,                 r,                 l,                 \
U_MT(a, met),      U_MT(o, alt),      U_MT(e, ctl),      U_MT(u, sft),      i,                 d,                 U_MT(h, sft),      U_MT(t, ctl),      U_MT(n, alt),      U_MT(s, met),      \
/,                 U_MT(q, ralt),     j,                 k,                 U_LT(x, U_MEDIA),  U_LT(b, U_FUN),    U_MT(m, ralt),     w,                 v,                 z,                 \
U_NP,              U_NP,              U_LT(tab, U_BRAC), U_LT(e, U_NAV),    U_LT(esc, U_BNFRD),U_LT(ent, U_NSYM), U_LT(spc, U_PUNC), U_NP,              U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_HALMAK \
w,                 l,                 r,                 b,                 z,                 U_QUOT,            q,                 u,                 d,                 j,                 \
U_MT(s, met),      U_MT(h, alt),      U_MT(n, ctl),      U_MT(t, sft),      U_COMM,            .,                 U_MT(a, sft),      U_MT(e, ctl),      U_MT(o, alt),      U_MT(i, met),      \
f,                 U_MT(m, ralt),     v,                 c,                 U_LT(/, U_MEDIA),  U_LT(g, U_FUN),    U_MT(p, ralt),     x,                 k,                 y,                 \
U_NP,              U_NP,              U_LT(tab, U_BRAC), U_LT(e, U_NAV),    U_LT(esc, U_BNFRD),U_LT(ent, U_NSYM), U_LT(spc, U_PUNC), U_NP,              U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_WORKMAN \
q,                 d,                 r,                 w,                 b,                 j,                 f,                 u,                 p,                 U_QUOT,            \
U_MT(a, met),      U_MT(s, alt),      U_MT(h, ctl),      U_MT(t, sft),      g,                 y,                 U_MT(n, sft),      U_MT(e, ctl),      U_MT(o, alt),      U_MT(i, met),      \
z,                 U_MT(x, ralt),     m,                 c,                 U_LT(v, U_MEDIA),  U_LT(k, U_FUN),    U_MT(l, ralt),     U_COMM,            .,                 /,                 \
U_NP,              U_NP,              U_LT(tab, U_BRAC), U_LT(e, U_NAV),    U_LT(esc, U_BNFRD),U_LT(ent, U_NSYM), U_LT(spc, U_PUNC), U_NP,              U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_QWERTY \
q,                 w,                 e,                 r,                 t,                 y,                 u,                 i,                 o,                 p,                 \
U_MT(a, met),      U_MT(s, alt),      U_MT(d, ctl),      U_MT(f, sft),      g,                 h,                 U_MT(j, sft),      U_MT(k, ctl),      U_MT(l, alt),      U_MT(U_QUOT, met), \
z,                 U_MT(x, ralt),     c,                 v,                 U_LT(b, U_MEDIA),  U_LT(n, U_FUN),    U_MT(m, ralt),     U_COMM,            .,                 /,                 \
U_NP,              U_NP,              U_LT(tab, U_BRAC), U_LT(e, U_NAV),    U_LT(esc, U_BNFRD),U_LT(ent, U_NSYM), U_LT(spc, U_PUNC), U_NP,              U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_QWERTZ \
q,                 w,                 e,                 r,                 t,                 z,                 u,                 i,                 o,                 p,                 \
U_MT(a, met),      U_MT(s, alt),      U_MT(d, ctl),      U_MT(f, sft),      g,                 h,                 U_MT(j, sft),      U_MT(k, ctl),      U_MT(l, alt),      U_MT(U_QUOT, met), \
y,                 U_MT(x, ralt),     c,                 v,                 U_LT(b, U_MEDIA),  U_LT(n, U_FUN),    U_MT(m, ralt),     U_COMM,            .,                 /,                 \
U_NP,              U_NP,              U_LT(tab, U_BRAC), U_LT(e, U_NAV),    U_LT(esc, U_BNFRD),U_LT(ent, U_NSYM), U_LT(spc, U_PUNC), U_NP,              U_NP,              U_NP
...
q,                 s,                 d,                 f,                 g,                 h,                 j,                 k,                 l,                 m,                 \
w,                 x,                 c,                 v,                 b,                 n,                 U_COMM,            .,                 /,                 U_QUOT,            \
U_NP,              U_NP,              tab,               e,                 esc,               ent,               spc,               U_NP,              U_NP,              U_NP
...
U_NA,              ralt,              U_DF(U_NUM),       U_NA,              U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
...
U_NA,              ralt,              U_DF(U_NUM),       U_NA,              U_NA,              home,              pgdn,              pgup,              end,               ins,               \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              ent,               bspc,              del,               U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_NAV \
U_NA,              U_DF(U_TAP),       U_DF(U_EXTRA),     U_DF(U_BASE),      U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
met,               alt,               ctl,               sft,               U_NA,              caps,              left,              down,              up,                right,             \
U_NA,              ralt,              U_DF(U_NUM),       U_NA,              U_NA,              ins,               home,              pgdn,              pgup,              end,               \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              ent,               bspc,              del,               U_NP,              U_NP
...
U_NA,              ralt,              U_DF(U_SYM),       U_NA,              U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              #(kp- kp5),        #(kp/ kp5),        #(kp* kp5),        U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_MOUSE_VI \
U_NA,              U_DF(U_TAP),       U_DF(U_EXTRA),     U_DF(U_BASE),      U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
met,               alt,               ctl,               sft,               U_NA,              kp4,               kp2,               kp8,               kp6,               U_NU,              \
U_NA,              ralt,              U_DF(U_SYM),       U_NA,              U_NA,              U_NU,              U_NU,              U_NU,              U_NU,              U_NU,              \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              #(kp- kp5),        #(kp/ kp5),        #(kp* kp5),        U_NP,              U_NP
...
U_NA,              ralt,              U_DF(U_FUN),       U_NA,              U_NA,              U_NU,              U_NU,              U_NU,              U_NU,              U_NU,              \
...
`,                 1,                 2,                 3,                 \\,                U_NA,              ralt,              U_NA,              U_NA,              U_NA,              \
...
~,                 !,                 @,                 #,                 U_PIPE,            U_NA,              ralt,              U_NA,              U_NA,              U_NA,              \
...
pause,             slck,              f6,                f5,                f12,               U_NA,              ralt,              U_NA,              U_NA,              U_NA,              \
