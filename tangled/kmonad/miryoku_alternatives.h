...
a,                 z,                 e,                 r,                 t,                 y,                 u,                 i,                 o,                 p,                 \
U_MT(q, met),      U_MT(s, alt),      U_MT(d, ctl),      U_MT(f, sft),      g,                 h,                 U_MT(j, sft),      U_MT(k, ctl),      U_MT(l, alt),      U_MT(m, met),      \
w,                 U_MT(x, ralt),     c,                 v,                 U_LT(b, MOUSE),    U_LT(n, FUN),      U_COMM,            .,                 U_MT(/, ralt),     U_QUOT,            \
U_NP,              U_NP,              U_LT(tab, MEDIA),  U_LT(e, NAV),      U_LT(esc, NUM),    U_LT(ent, NSYM),   U_LT(spc, PUNC),   U_LT(bspc, BRAC),  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_BEAKL15 \
q,                 h,                 o,                 u,                 x,                 g,                 c,                 r,                 f,                 z,                 \
U_MT(y, met),      U_MT(i, alt),      U_MT(e, ctl),      U_MT(a, sft),      .,                 d,                 U_MT(s, sft),      U_MT(t, ctl),      U_MT(n, alt),      U_MT(b, met),      \
j,                 U_MT(/, ralt),     U_COMM,            k,                 U_LT(U_QUOT, MOUSE), U_LT(w, FUN),      m,                 l,                 U_MT(p, ralt),     v,                 \
U_NP,              U_NP,              U_LT(tab, MEDIA),  U_LT(e, NAV),      U_LT(esc, NUM),    U_LT(ent, NSYM),   U_LT(spc, PUNC),   U_LT(bspc, BRAC),  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAK \
q,                 w,                 f,                 p,                 g,                 j,                 l,                 u,                 y,                 U_QUOT,            \
U_MT(a, met),      U_MT(r, alt),      U_MT(s, ctl),      U_MT(t, sft),      d,                 h,                 U_MT(n, sft),      U_MT(e, ctl),      U_MT(i, alt),      U_MT(o, met),      \
z,                 U_MT(x, ralt),     c,                 v,                 U_LT(b, MOUSE),    U_LT(k, FUN),      m,                 U_COMM,            U_MT(., ralt),     /,                 \
U_NP,              U_NP,              U_LT(tab, MEDIA),  U_LT(e, NAV),      U_LT(esc, NUM),    U_LT(ent, NSYM),   U_LT(spc, PUNC),   U_LT(bspc, BRAC),  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAKDH \
q,                 w,                 f,                 p,                 b,                 j,                 l,                 u,                 y,                 U_QUOT,            \
U_MT(a, met),      U_MT(r, alt),      U_MT(s, ctl),      U_MT(t, sft),      g,                 m,                 U_MT(n, sft),      U_MT(e, ctl),      U_MT(i, alt),      U_MT(o, met),      \
z,                 U_MT(x, ralt),     c,                 d,                 U_LT(v, MOUSE),    U_LT(k, FUN),      h,                 U_COMM,            U_MT(., ralt),     /,                 \
U_NP,              U_NP,              U_LT(tab, MEDIA),  U_LT(e, NAV),      U_LT(esc, NUM),    U_LT(ent, NSYM),   U_LT(spc, PUNC),   U_LT(bspc, BRAC),  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAKDHK \
q,                 w,                 f,                 p,                 b,                 j,                 l,                 u,                 y,                 U_QUOT,            \
U_MT(a, met),      U_MT(r, alt),      U_MT(s, ctl),      U_MT(t, sft),      g,                 k,                 U_MT(n, sft),      U_MT(e, ctl),      U_MT(i, alt),      U_MT(o, met),      \
z,                 U_MT(x, ralt),     c,                 d,                 U_LT(v, MOUSE),    U_LT(m, FUN),      h,                 U_COMM,            U_MT(., ralt),     /,                 \
U_NP,              U_NP,              U_LT(tab, MEDIA),  U_LT(e, NAV),      U_LT(esc, NUM),    U_LT(ent, NSYM),   U_LT(spc, PUNC),   U_LT(bspc, BRAC),  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_DVORAK \
U_QUOT,            U_COMM,            .,                 p,                 y,                 f,                 g,                 c,                 r,                 l,                 \
U_MT(a, met),      U_MT(o, alt),      U_MT(e, ctl),      U_MT(u, sft),      i,                 d,                 U_MT(h, sft),      U_MT(t, ctl),      U_MT(n, alt),      U_MT(s, met),      \
/,                 U_MT(q, ralt),     j,                 k,                 U_LT(x, MOUSE),    U_LT(b, FUN),      m,                 w,                 U_MT(v, ralt),     z,                 \
U_NP,              U_NP,              U_LT(tab, MEDIA),  U_LT(e, NAV),      U_LT(esc, NUM),    U_LT(ent, NSYM),   U_LT(spc, PUNC),   U_LT(bspc, BRAC),  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_HALMAK \
w,                 l,                 r,                 b,                 z,                 U_QUOT,            q,                 u,                 d,                 j,                 \
U_MT(s, met),      U_MT(h, alt),      U_MT(n, ctl),      U_MT(t, sft),      U_COMM,            .,                 U_MT(a, sft),      U_MT(e, ctl),      U_MT(o, alt),      U_MT(i, met),      \
f,                 U_MT(m, ralt),     v,                 c,                 U_LT(/, MOUSE),    U_LT(g, FUN),      p,                 x,                 U_MT(k, ralt),     y,                 \
U_NP,              U_NP,              U_LT(tab, MEDIA),  U_LT(e, NAV),      U_LT(esc, NUM),    U_LT(ent, NSYM),   U_LT(spc, PUNC),   U_LT(bspc, BRAC),  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_WORKMAN \
q,                 d,                 r,                 w,                 b,                 j,                 f,                 u,                 p,                 U_QUOT,            \
U_MT(a, met),      U_MT(s, alt),      U_MT(h, ctl),      U_MT(t, sft),      g,                 y,                 U_MT(n, sft),      U_MT(e, ctl),      U_MT(o, alt),      U_MT(i, met),      \
z,                 U_MT(x, ralt),     m,                 c,                 U_LT(v, MOUSE),    U_LT(k, FUN),      l,                 U_COMM,            U_MT(., ralt),     /,                 \
U_NP,              U_NP,              U_LT(tab, MEDIA),  U_LT(e, NAV),      U_LT(esc, NUM),    U_LT(ent, NSYM),   U_LT(spc, PUNC),   U_LT(bspc, BRAC),  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_QWERTY \
q,                 w,                 e,                 r,                 t,                 y,                 u,                 i,                 o,                 p,                 \
U_MT(a, met),      U_MT(s, alt),      U_MT(d, ctl),      U_MT(f, sft),      g,                 h,                 U_MT(j, sft),      U_MT(k, ctl),      U_MT(l, alt),      U_MT(U_QUOT, met), \
z,                 U_MT(x, ralt),     c,                 v,                 U_LT(b, MOUSE),    U_LT(n, FUN),      m,                 U_COMM,            U_MT(., ralt),     /,                 \
U_NP,              U_NP,              U_LT(tab, MEDIA),  U_LT(e, NAV),      U_LT(esc, NUM),    U_LT(ent, NSYM),   U_LT(spc, PUNC),   U_LT(bspc, BRAC),  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_QWERTZ \
q,                 w,                 e,                 r,                 t,                 z,                 u,                 i,                 o,                 p,                 \
U_MT(a, met),      U_MT(s, alt),      U_MT(d, ctl),      U_MT(f, sft),      g,                 h,                 U_MT(j, sft),      U_MT(k, ctl),      U_MT(l, alt),      U_MT(U_QUOT, met), \
y,                 U_MT(x, ralt),     c,                 v,                 U_LT(b, MOUSE),    U_LT(n, FUN),      m,                 U_COMM,            U_MT(., ralt),     /,                 \
U_NP,              U_NP,              U_LT(tab, MEDIA),  U_LT(e, NAV),      U_LT(esc, NUM),    U_LT(ent, NSYM),   U_LT(spc, PUNC),   U_LT(bspc, BRAC),  U_NP,              U_NP
...
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              ent,               del,               bspc,              U_NP,              U_NP
...
XX,                U_NA,              U_NA,              U_NA,              U_NA,              U_LPRN,            7,                 8,                 9,                 U_RPRN,            \
met,               alt,               ctl,               sft,               U_NA,              +,                 1,                 2,                 3,                 4,                 \
U_NA,              ralt,              U_NA,              U_NA,              U_NA,              -,                 5,                 6,                 *,                 /,                 \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              spc,               0,                 .,                 U_NP,              U_NP
...
f10,               f9,                f8,                f7,                sysrq,             U_NA,              U_NA,              U_NA,              U_NA,              XX,                \
f4,                f3,                f2,                f1,                slck,              U_NA,              sft,               ctl,               alt,               met,               \
f12,               f11,               f6,                f5,                pause,             U_NA,              U_NA,              U_NA,              ralt,              U_NA,              \
